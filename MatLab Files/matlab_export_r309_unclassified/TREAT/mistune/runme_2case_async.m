...
a = PWM_Signal(PD,10*PRI,Ts,floor(Fs*CPI),floor(1*PRI*Fs));
b = PWM_Signal(PD,10*PRI,Ts,floor(Fs*CPI),floor(4*PRI*Fs));
c = PWM_Signal(PD,10*PRI,Ts,floor(Fs*CPI),floor(9*PRI*Fs));
c = PWM_Signal(PD,10*PRI,Ts,floor(Fs*CPI),floor(10*PRI*Fs));
rf_in = a + b + c;
