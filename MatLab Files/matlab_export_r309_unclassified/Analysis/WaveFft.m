function [sig_fft, sig_fft_freq, sig_psd, sig_cpsd] = WaveFft(tdSignal,tdWindow,Fs,NFFT,Option,varargin)
...
sig_fft = fft(tdWindow.*tdSignal,NFFT) ./ NFFT ./ window_frac;
sig_fft_freq = Fs * ((0:(NFFT-1)) ./ NFFT);
...
if(exist('Option','var'))
    ...
    elseif ( strcmp(Option,'twosided'))
        sig_fft_freq = (-NFFT/2:(NFFT/2-1)) .* (Fs / NFFT);
