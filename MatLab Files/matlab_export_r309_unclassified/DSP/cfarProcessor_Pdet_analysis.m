...
addpath('I:\MATLAB\Signal Generation\Noise Signal\')
c = lines;
...
nTrain = 10;
nGuard     = 1;
settingPfa = 1e-5;  % probability of false alarm
...
for irep = 1:nrep
    ...
    x2 = abs(x).^2;
        nCells = 2*nTrain;
        alpha = nCells .* (settingPfa^(-1/nCells) - 1);
    ...
    if(~exist('hfig'))
        ...
        set(hp(5),'XData',1:irep,'YData',Pdet(1:irep)*100)
        set(hp(6),'XData',1:irep,'YData',Pfa(1:irep)*100)
