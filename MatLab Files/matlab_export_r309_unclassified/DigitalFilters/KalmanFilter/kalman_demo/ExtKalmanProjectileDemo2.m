...
radar_measurement_error_angle = 1*0.0175; % radians
radar_position_x = 85;
radar_position_y = 0;
...
CannonPosition_x = 0;
CannonPosition_y = 0;
MuzzleVelocity_x = 100;
MuzzleVelocity_y = 100;
...
plot( MeasuredX, MeasuredY, '.', ...
    TruthData.position_x-radar_position_x, TruthData.position_y-radar_position_y,'.');
grid on;
...
print -dpng -r180 -f3 Figure3_3.png
print -dpng -r180 -f4 Figure4_3.png
print -dpng -r180 -f5 Figure5_4.png
print -dpng -r180 -f6 Figure6_4.png